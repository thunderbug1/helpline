...
function get_emergency_numbers() {
    ...
    if (country_data.Emergency === null) {
        ...
        document.getElementById("emergency-button").href = "javascript:void(0)"
    } else {
    ...
    if (country_data.Ambulance === null) {
        ...
        document.getElementById("ambulance-button").href = "javascript:void(0)"
    } else {
        document.getElementById("ambulance-overlay").style.zIndex = "-1";
        document.getElementById("ambulance-button").href = "Tel:" + country_data.Ambulance.split(' ')[0].replace(regex, "");
    }

    if (country_data.Fire === null) {
        document.getElementById("fire-overlay").style.zIndex = "10";
        document.getElementById("fire-button").href = "javascript:void(0)"
    } else {
        document.getElementById("fire-overlay").style.zIndex = "-1";
        document.getElementById("fire-button").href = "Tel:" + country_data.Fire.split(' ')[0].replace(regex, "");
    }

    if (country_data.Police === null) {
        document.getElementById("police-overlay").style.zIndex = "10";
        document.getElementById("police-button").href = "javascript:void(0)"
    } else {
        document.getElementById("police-overlay").style.zIndex = "-1";
        document.getElementById("police-button").href = "Tel:" + country_data.Police.split(' ')[0].replace(regex, "");
    }
}
